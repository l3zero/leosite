...
export function editIntro(tl, elements) {
   tl.from(elements[0], {ease: 'steps(10)', y: '200%', opacity: 0, delay: 0.3, duration: 2})
      .from(elements[1], {
         ease: 'none',
         text: {
            value: '   ',
      ...
      .from(elements[4], {ease: 'elastic', duration: 1.5, y: '500%'})
      .from(elements[5], {y: '-500%', duration: 1.5, scaleY: '5'})
